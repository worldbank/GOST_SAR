```javascript
/*===========================================================================================
       SAR-FLOOD MAPPING USING THE NORMALISED DIFFERENCE FLOOD INDEX APPROACH
  ===========================================================================================
  
  Within this script SAR Sentinel-1 is being used to generate a flood extent map
  using the Normalised Difference Flood Index approach defined in Cian et al.(2018) 
...
var before_start='2021-03-21';
var before_end='2021-03-31';

// Now set the same parameters for AFTER the flood in YYYY-MM-DD format.
var after_start='2021-04-01';
var after_end='2021-04-06';

/********************************************************************************************
                           SET SAR PARAMETERS (can be left default)*/
var polarization = "VH"; /*or 'VH' --> VH mostly is the prefered polarization for flood mapping.
...
var ndfi_thres= 0.7;    /* NDFI default threshold 0.7 (conservative)
...
// Calculate the NDFI and the flood image
...
var text8 = ui.Label('Modified by: Geospatial Operation Support Team, World Bank, November 2020', subTextVis);
